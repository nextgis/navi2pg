 ...
 *
 * Вызов
 *  navi2pg [-h] [--help] [-v] [--version] [--sign_cp1251] --schema <schema_name> <pg_connection_string> <S57_datasource_name> <mapserevr_config_template_filename> <mapnik_config_template_filename> <mapnik_pyscript_template_filename>
 *
 * Описание
